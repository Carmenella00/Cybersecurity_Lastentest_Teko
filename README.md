...
Damit das Python-Skript einfacher ausgeführt werden kann, steht zusätzlich folgendes Startskript zur Verfügung:

```text
run-loadtest.sh
```

Das Startskript lädt die benötigten Umgebungsvariablen aus `.env`, verwendet die virtuelle Python-Umgebung und startet das Python-Skript.
